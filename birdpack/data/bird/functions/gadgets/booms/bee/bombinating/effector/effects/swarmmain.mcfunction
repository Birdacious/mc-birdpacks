# as @e[type=area_effect_cloud, tag=bombinatingeffector, tag=detectground] at @s --> as @e[distance=..4, type=#living_entity, sort=nearest, limit=1] at @s
...
function bird:gadgets/booms/bee/bombinating/effector/effects/chase
tag @s remove chase

# particles
function bird:gadgets/booms/bee/bombinating/effector/effects/particles
...
execute if score @s stingtimer matches 20 run function bird:gadgets/booms/bee/bombinating/effector/effects/sting
