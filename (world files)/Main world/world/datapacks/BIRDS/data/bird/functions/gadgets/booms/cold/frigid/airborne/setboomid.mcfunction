# as @e[nbt={Item:{tag:{boom:"frigid"}}}] at @s if entity @s[tag=!boomidset]
...
execute store result score @s boomid run execute if entity @e[tag=frigideffector]
execute store result score @e[tag=frigideffector, sort=nearest, limit=1] boomid run execute if entity @e[tag=frigideffector]
