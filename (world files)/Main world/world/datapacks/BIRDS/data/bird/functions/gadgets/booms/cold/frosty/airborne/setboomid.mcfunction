# as @e[nbt={Item:{tag:{boom:"frosty"}}}] at @s if entity @s[tag=!boomidset]
...
execute store result score @s boomid run execute if entity @e[tag=frostyeffector]
execute store result score @e[tag=frostyeffector, sort=nearest, limit=1] boomid run execute if entity @e[tag=frostyeffector]
